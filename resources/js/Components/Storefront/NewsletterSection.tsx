	...
	return (
		<section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 pt-16 sm:pt-24">
			<ScrollReveal effect="scale-up" duration={800}>
				<div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#111FA2] via-[#0D1780] to-[#080E4E] text-white p-6 sm:p-12 lg:p-14 shadow-2xl border border-[#5478FF]/20 mb-4 sm:mb-8">
							...
							{submitted ? (
								<>
									...
									<p className="mt-3 text-slate-200 max-w-md text-sm leading-relaxed">
										Customer service kami siap membantu penjadwalan survey lokasi, pengukuran, dan estimasi biaya material & jasa di Bekasi dan sekitarnya.
									</p>
								</>
							) : (
								<>
									...
									<p className="mt-3 sm:mt-4 text-slate-200 max-w-md leading-relaxed text-xs sm:text-sm">
										Dapatkan bantuan pemilihan material, perhitungan kebutuhan luasan kaca/dinding, dan penjadwalan teknisi survey ke lokasi Anda di wilayah <strong className="text-white font-semibold">Bekasi & seluruh Jabodetabek</strong>.
									</p>
									<div className="mt-5 sm:mt-6 flex flex-wrap items-center gap-4 text-xs text-slate-200">
